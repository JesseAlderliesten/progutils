...
expect_warning(
  expect_identical(
    replace_vals(x = "A", old = "a", new = new, ignore_case = TRUE,
...
expect_warning(
  expect_identical(
    replace_vals(x = "A", old = "a", new = new, ignore_case = FALSE,
                 warn_absent = TRUE),
    "A"),
...
# 'old' match 'x'.
expect_error(
  replace_vals(x = x, old = letters[13:12], new = new, allow_multiple = FALSE),
  pattern = paste0(warn_mult_old, "'m', 'l') matched 'x' (",
                   x_quoted, "): 'l', 'm'"),
  fixed = TRUE
)
...
for(allow_multiple in c(TRUE, FALSE)) {
  expect_message(
    expect_identical(
      replace_vals(x = x_mixed, old = old, new = new, ignore_case = TRUE,
                   allow_multiple = allow_multiple, signal_case_old = "quiet"),
      x_mixed_out),
    pattern = msg_replace_mult, strict = TRUE, fixed = TRUE)

  expect_message(
    expect_identical(
      replace_vals(x = as.factor(x_mixed), old = old, new = new, ignore_case = TRUE,
                   allow_multiple = allow_multiple, signal_case_old = "quiet"),
...
expect_message(
  expect_identical(
    replace_vals(x = toupper(x_rep), old = old, new = new, ignore_case = TRUE,
...
expect_message(
  expect_identical(
    replace_vals(x = x_rep, old = old_upper, new = new, ignore_case = TRUE,
                 allow_multiple = FALSE),
    rep(x_out, 2)),
...
expect_warning(
  expect_identical(
    replace_vals(x = as.factor(x), old = "v", new = "K", ignore_case = TRUE,
                 warn_absent = TRUE),
    as.factor(x)),
  pattern = paste0(warn_match_case, "'new' ('K'): 'k'"),
  strict = TRUE, fixed = TRUE
...
expect_message(
  expect_identical(
    replace_vals(x = c(x, new), old = old, new = new, ignore_case = TRUE,
...
expect_silent(
  expect_identical(
    replace_vals(x = "A", old = "a", new = "A", ignore_case = TRUE,
                 signal_case_old = "quiet", quiet = FALSE),
    "A")
)
...
for(ignore_case in c(TRUE, FALSE)) {
  expect_error(
    replace_vals(x = c("a", "B"), old = "a", new = new, ignore_case = ignore_case,
                 warn_absent = TRUE, signal_case_new = "error"),
    pattern = paste0(warn_match_case, "'new' ('b'): 'B'"), fixed = TRUE)

  expect_warning(
    expect_identical(
      replace_vals(x = c("a", "B"), old = "a", new = new, ignore_case = ignore_case,
                   signal_case_new = "warning"),
      c("b", "B")),
  ...
  expect_warning(
    expect_identical(
      replace_vals(x = as.factor(c("a", "B")), old = "a", new = new, ignore_case = ignore_case,
                   signal_case_new = "warning"),
      as.factor(c("b", "B"))),
    pattern = paste0(warn_match_case, "'new' ('b'): 'B'"),
    strict = TRUE, fixed = TRUE)
...
expect_error(
  replace_vals(x = x[1:2], old = rev(x), new = new, ignore_case = ignore_case,
               allow_multiple = FALSE),
...
expect_message(
  expect_identical(
    replace_vals(x = x_mixed, old = c("q", old), new = new, ignore_case = FALSE,
                 allow_multiple = FALSE, signal_case_old = "quiet"),
    c(x_out, x_upper)),
  pattern = msg_replace, strict = TRUE, fixed = TRUE
)
...
expect_warning(
  expect_identical(
    replace_vals(x = x_mixed, old = c("q", old), new = new, ignore_case = TRUE,
                 allow_multiple = FALSE),
    x_mixed_out),
