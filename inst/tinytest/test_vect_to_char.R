...
#### Test the examples ####
expect_identical(vect_to_char(x = a), "a: 1, b: 2, c: 3")
expect_identical(vect_to_char(x = a, collapse = NULL), c("a: 1", "b: 2", "c: 3"))
expect_identical(vect_to_char(x = unname(a)), "1, 2, 3")

expect_identical(
  vect_to_char(x = b, signif = 7), "a: 0.1428571, b: 0.2857143, c: 0.4285714")
expect_identical(
