...
`get_file_path()` includes 'hidden' files, i.e., files with names that
start with a dot, but excludes directories.
...
**includes** directories in its output) to check for existence of files
without checking they are a unique match to a pattern;
...
#> Using file '/tmp/Rtmp88juUO/examplegetfilepath191543898069/some_filename.txt'
#> /tmp/Rtmp88juUO/examplegetfilepath191543898069/some_filename.txt
...
#> '/tmp/Rtmp88juUO/examplegetfilepath191543898069'.
...
#> Using file '/tmp/Rtmp88juUO/examplegetfilepath191543898069/another_filename.txt'
#> /tmp/Rtmp88juUO/examplegetfilepath191543898069/another_filename.txt
