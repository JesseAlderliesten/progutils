...
Check that only one file in directory `dir` has a name matching
`pattern`, for example before attempting to [read a
...
#> Using file 'some_filename196444b6bbc6.txt'
#> [1] "some_filename196444b6bbc6.txt"
...
#> '/tmp/RtmpfMHouA'.
#> However, a case-insensitive match to 'pattern' is present: 'some_filename196444b6bbc6.txt'.
...
#> '/tmp/RtmpfMHouA': 'another_filename196448be84fa.txt', 'some_filename196444b6bbc6.txt'!
