...
Using `relevel` or [`levels()`](https://rdrr.io/r/base/levels.html) to
reorder factor levels does *not* work, whereas function
...
to prevent text from running of the plot. Combining
