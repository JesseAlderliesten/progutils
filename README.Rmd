...
`progutils` contains utility functions I frequently use: functions to check
equality, functions to construct messages about an input vector, and functions
...
frequently they have 'misc' or 'util' in the title or description. In addition,
